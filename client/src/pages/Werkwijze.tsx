...
export default function Werkwijze() {
  useSEO({
    ...
    path: "/werkwijze",
    imageAlt:
      "De werkwijze van De Proces Designers — leadgeneratie binnen 4 weken live",
    schema: [
      breadcrumb([
        { name: "Home", path: "/" },
      ...
      ]),
      {
        ...
        mainEntity: [
          {
            "@type": "Question",
            name: "Wanneer zie ik de eerste leads binnenkomen?",
            acceptedAnswer: {
              "@type": "Answer",
              text: "In de meeste gevallen binnen 7 dagen na lancering. Campagnes worden in week 1 al gelanceerd.",
            },
          },
          {
            "@type": "Question",
            name: "Wat heb ik zelf nodig te doen?",
            acceptedAnswer: {
              "@type": "Answer",
              text: "Toegang verlenen tot jouw Meta-accounts en beschikbaar zijn voor een onboardinggesprek. De rest nemen wij volledig over.",
            },
          },
          {
            "@type": "Question",
            name: "Werken jullie met vaste contracten?",
            acceptedAnswer: {
              "@type": "Answer",
              text: "Wij werken met maandelijkse overeenkomsten zonder langetermijn lock-in. Je behoudt altijd de controle.",
            },
          },
          {
            "@type": "Question",
            name: "Zijn de leads echt exclusief voor mijn bedrijf?",
            acceptedAnswer: {
              "@type": "Answer",
              text: "Altijd. Wij bouwen campagnes specifiek voor jouw bedrijf en regio. Geen leadplatforms, geen gedeelde aanvragen.",
            },
          },
          {
            "@type": "Question",
            name: "Werken jullie ook voor boekhouders en financieel dienstverleners?",
            acceptedAnswer: {
              "@type": "Answer",
              text: "Ja. Naast dakdekkers werken wij voor boekhouders, accountants, financieel adviseurs en letselschadekantoren. De werkwijze is identiek: een leadcampagne op maat voor jouw niche en regio.",
            },
          },
        ],
      },
